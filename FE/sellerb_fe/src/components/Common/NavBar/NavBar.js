...
import 
  { NotificationOutlined, YoutubeOutlined, 
    ...
    <>
      <div className="navbar-wrapper">
        <div className="navbar-left">
            ...
            />
          <div className="small-sellerb" onClick={onGoMain}>SellerB</div>
        </div>
        ...
        <div className="navbar-right">
          {isManager ? (
            <div className="navbar-right-navigator">
              ...
              >
                <YoutubeOutlined id="meet-icon" />회의생성
              </div>
              ...
              <LogoutOutlined id="logout-icon" />로그아웃
              </div>
            </div>
          ) : (
            <div className="navbar-right-navigator">
